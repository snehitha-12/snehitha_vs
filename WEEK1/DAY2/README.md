...
2. **Open the file:**
   ...
   ```
 ![SKY130_lib](images/sky130_lib.png)
...
**Example:**
![dff_asynch_set_heir](images/dff_asynch_set_hier.png)
...
![dff_asynch_set_flatten](images/dff_asynch_set_flatten.png)
...
3. **View Waveform:**
   ...
   ```
![dff_asyncres](images/dff_asyncres_simulation.png)
...
7. Visualize the gate-level netlist:
   ...
   show
   ```
![dff_asyncres_synth](images/dff_asynchres_synthesis.png)
